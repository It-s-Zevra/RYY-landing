...
export function ShareBar({ title, url }: { title: string; url: string }) {
  ...
  const base =
    "flex h-11 w-11 items-center justify-center rounded-pill border border-obsidian/25 text-obsidian transition-colors hover:border-cape hover:bg-cape hover:text-porcelain";

  return (
    <div className="flex items-center gap-3">
      <span className="font-mono text-[10px] uppercase tracking-[0.18em] text-obsidian/60">
        Compartir
      </span>
